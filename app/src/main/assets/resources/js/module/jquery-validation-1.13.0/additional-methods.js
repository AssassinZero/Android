...
jQuery.validator.addMethod("isMobile", function(value, element){
    ...
    return (this.optional(element) || length == 11 && /^0?(13[0-9]|15[012356789]|17[04678]|18[0-9]|14[5768]|16[6]|19[89])[0-9]{8}$/.test(value));
}, "请填写正确的手机号码");
//-E-手机号码验证
...
// -S-贷款金额验证
jQuery.validator.addMethod("testNumber", function(value, element){
	var $money = $(".money").val();
	if($money < 1){
		return false
	}else{
...
jQuery.validator.addMethod("regexEmail", function(value, element) {
    return !value || this.optional(element) || /^([a-zA-Z0-9_-])+@([a-zA-Z0-9_-])+((\.[a-zA-Z0-9_-]{2,3}){1,2})$/.test(value);  
}, "数字加字母或者字符两种以上的在字符");
// -E-邮箱校验
...
//-S-是否为正确的车牌号码校验
jQuery.validator.addMethod("isRe",function(value,element){
...
jQuery.validator.addMethod("isAdd",function(value,element){
	return this.optional(element) || /^(?=.*?[\u4E00-\u9FA5])[\dA-Za-z\u4E00-\u9FA5]+/.test(value);
},"中文字母数字的组合");
