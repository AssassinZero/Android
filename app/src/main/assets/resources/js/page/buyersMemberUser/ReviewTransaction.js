...
define(function(require, exports, module) {
	...
	var getListDate = function() {
		...
		function insetDate(data) {
			var tpl = require('/resources/tpls/buyersMemberUser/ReviewTransaction.tpl'); //载入tpl模板
		...
		$.ajax({
			url: "/modules/business/action/membershipBusinessAction/buyBillOrders.htm?businessState="+"0041" ,
			type: "get",
			dataType: "json",
			data: {
				currentPage: 1,
				...
				if (data.page.total > 0) {
					var obj11 = {
						...
						click: function(n, total, totalRecords) {
							$.ajax({
								type: "get",
								url: "/modules/business/action/membershipBusinessAction/buyBillOrders.htm?businessState="+'0041'+"&currentPage=" + n + "&pageSize=" + data.page.pageSize, 
	...
	function operationClick(checkData) {
		require.async(['/resources/js/module/layer/skin/default/layer.css', '/resources/js/module/layer/layer.min'], function () {
			 ...
			 * [确认]
			 */
			$('#tradeClosed .buyersMemberConfirm').unbind("click").click(function (e) {
			...
			/**
				* [订单撤回] 
				*/
			$('#tradeClosed .buyersMemberRevoke').click(function () {
			 ...
			 * [订单退回]
			 */
			$('#tradeClosed .buyersMemberReturn').unbind("click").bind("click", function (e) {
			...
			/**
				* [订单关闭] 
				*/
			$('#tradeClosed .buyersMemberClose').click(function () {
			 ...
			 * [试户]
			 */
			$('#tradeClosed .buyersMemberTestUser').click(function (e) {
			 ...
			 * [复核]
			 */
			$('#tradeClosed .buyersMemberReview').unbind("click").click(function (e) {
				console.log(11)
				var rid = $(this).attr("data-id")
				$.ajax({
					url: "/modules/business/action/directBusinessAction/queryOrderDetail.htm",
			 ...
			 * [签收并支付]
			 */
			$('#tradeClosed .buyersMemberSignPay').unbind("click").click(function (e) {
			 ...
			 * [修改订单]
			 */
			$('#tradeClosed .buyersMemberChange').unbind("click").click(function (e) {
				var rid = $(this).attr("data-id") 
