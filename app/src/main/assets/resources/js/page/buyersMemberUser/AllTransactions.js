...
define(function (require, exports, module) {
	...
	var getListDate = function () {
		...
		function insetDate(data) {
			var tpl = "";
			tpl = require('/resources/tpls/buyersMemberUser/AllTransactions.tpl'); //载入tpl模板 
		...
		$.ajax({
			url: "/modules/business/action/membershipBusinessAction/buyBillOrders.htm",
			type: "get",
			dataType: "json",
			data: {
				currentPage: 1,
				...
				if (data.page.total > 0) {
					var obj11 = {
						...
						click: function (n, total, totalRecords) {
							$.ajax({
								type: "get",
								url: "/modules/business/action/membershipBusinessAction/buyBillOrders.htm?currentPage=" + n + "&pageSize=" + data.page.pageSize, 
	...
	function operationClick(checkData) {
		require.async(['/resources/js/module/layer/skin/default/layer.css', '/resources/js/module/layer/layer.min'], function () {
			 ...
			 * [确认]
			 */
			$('#tradingOrder .buyersMemberConfirm').unbind("click").click(function (e) {
			...
			/**
				* [订单撤回] 
				*/
			$('#tradingOrder .buyersMemberRevoke').click(function () {
			 ...
			 * [订单退回]
			 */
			$('#tradingOrder .buyersMemberReturn').unbind("click").bind("click", function (e) {
			...
			/**
				* [订单关闭] 
				*/
			$('#tradingOrder .buyersMemberClose').click(function () {
			 ...
			 * [试户]
			 */
			$('#tradingOrder .buyersMemberTestUser').click(function (e) {
			 ...
			 * [复核]
			 */
			$('#tradingOrder .buyersMemberReview').unbind("click").click(function (e) {
				var rid = $(this).attr("data-id")
				$.ajax({
					url: "/modules/business/action/directBusinessAction/queryOrderDetail.htm",
					type: "get",
			 ...
			 * [签收并支付]
			 */
			$('#tradingOrder .buyersMemberSignPay').unbind("click").click(function (e) {
                var rid = $(this).attr("data-id")
			 ...
			 * [修改订单]
			 */
			$('#tradingOrder .buyersMemberChange').unbind("click").click(function (e) {
				var rid = $(this).attr("data-id") 
