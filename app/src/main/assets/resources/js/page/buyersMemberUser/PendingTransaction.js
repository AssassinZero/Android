...
define(function(require, exports, module) {
	...
	var getListDate = function() {
		...
		function insetDate(data) {
			var tpl = require('/resources/tpls/buyersMemberUser/PendingTransaction.tpl'); //载入tpl模板
		...
		$.ajax({
			url: "/modules/business/action/membershipBusinessAction/buyBillOrders.htm?businessState="+"0011,0010" ,
			type: "get",
			dataType: "json",
			data: {
				currentPage: 1,
				...
				if (data.page.total > 0) {
					var obj11 = {
						...
						click: function(n, total, totalRecords) {
							$.ajax({
								type: "get",
								url: "/modules/business/action/membershipBusinessAction/buyBillOrders.htm?businessState="+'0011,0010'+"&currentPage=" + n + "&pageSize=" + data.page.pageSize, 
	...
	function operationClick(checkData) {
		require.async(['/resources/js/module/layer/skin/default/layer.css', '/resources/js/module/layer/layer.min'], function () {
			 ...
			 * [确认]
			 */
			$('#tradedOrder .buyersMemberConfirm').unbind("click").click(function (e) {
			...
			/**
				* [订单撤回] 
				*/
			$('#tradedOrder .buyersMemberRevoke').click(function () {
			 ...
			 * [订单退回]
			 */
			$('#tradedOrder .buyersMemberReturn').unbind("click").bind("click", function (e) {
			...
			/**
				* [订单关闭] 
				*/
			$('#tradedOrder .buyersMemberClose').click(function () {
			 ...
			 * [试户]
			 */
			$('#tradedOrder .buyersMemberTestUser').click(function (e) {
			 ...
			 * [复核]
			 */
			$('#tradedOrder .buyersMemberReview').unbind("click").click(function (e) {
				var rid = $(this).attr("data-id")
				$.ajax({
					url: "/modules/business/action/directBusinessAction/queryOrderDetail.htm",
					type: "get",
			 ...
			 * [签收并支付]
			 */
			$('#tradedOrder .buyersMemberSignPay').unbind("click").click(function (e) {
                var now = new Date();
			 ...
			 * [修改订单]
			 */
			$('#tradedOrder .buyersMemberChange').unbind("click").click(function (e) {
				var rid = $(this).attr("data-id") 
