...
define(function(require, exports, module) {
	...
	var getListDate = function() {
		...
		function insetDate(data) {
			var tpl = require('/resources/tpls/sellerMemberUser/PendingTransaction.tpl'); //载入tpl模板
        ...
        //模拟数据end  
		$.ajax({
			url: "/modules/business/action/membershipBusinessAction/sellBillOrders.htm?businessState="+'0012,0010',
			type: "get",
			dataType: "json",
			data: {
				currentPage: 1,
				...
				if (data.page.total > 0) {
					var obj11 = {
						...
						click: function(n, total, totalRecords) {
							$.ajax({
								type: "get", 
								url: "/modules/business/action/membershipBusinessAction/sellBillOrders.htm?businessState="+'0012,0010'+"&currentPage=" + n + "&pageSize=" + data.page.pageSize, 
	...
	function operationClick(checkData) { 
			...
			/**
				* [订单撤回] 
				*/
			$('#tradedOrder .sellerMemberRevoke').click(function () {
			...
			/**
				* [订单退回] 
				*/
			$('#tradedOrder .sellerMemberReturn').click(function () {
			 ...
			 * [确认]
			 */
			$('#tradedOrder .sellerMemberConfirm').unbind("click").click(function (e) {
			...
			/**
				* [订单关闭] 
				*/
			$('#tradedOrder .sellerMemberClose').click(function () {
			 ...
			 * [修改订单]
			 */
			$('#tradedOrder .sellerMemberChange').unbind("click").click(function (e) {
				var rid = $(this).attr("data-id") 
