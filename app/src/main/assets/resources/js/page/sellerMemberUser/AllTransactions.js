...
define(function(require, exports, module) {
	...
	var getListDate = function() {
		...
		function insetDate(data) {
			var tpl = ""; 
				tpl = require('/resources/tpls/sellerMemberUser/AllTransactions.tpl'); //载入tpl模板 
        ...
        //模拟数据end  
		$.ajax({
			url: "/modules/business/action/membershipBusinessAction/sellBillOrders.htm",
			type: "get",
			dataType: "json",
			data: {
				currentPage: 1,
				...
				if (data.page.total > 0) {
					var obj11 = {
						...
						click: function(n, total, totalRecords) {
							$.ajax({
								type: "get", 
								url: "/modules/business/action/membershipBusinessAction/sellBillOrders.htm?currentPage=" + n + "&pageSize=" + data.page.pageSize,  
	...
	function operationClick(checkData) { 
			...
			/**
				* [订单撤回] 
				*/
			$('#tradingOrder .sellerMemberRevoke').click(function () {
			...
			/**
				* [订单退回] 
				*/
			$('#tradingOrder .sellerMemberReturn').click(function () {
			 ...
			 * [确认]
			 */
			$('#tradingOrder .sellerMemberConfirm').unbind("click").click(function (e) {
			...
			/**
				* [订单关闭] 
				*/
			$('#tradingOrder .sellerMemberClose').click(function () {
			 ...
			 * [修改订单]
			 */
			$('#tradingOrder .sellerMemberChange').unbind("click").click(function (e) {
				var rid = $(this).attr("data-id") 
