	...
	require.async('/resources/js/module/handlebars-v1.3.0/handlebars-v1.3.0', function () {
		require.async('/resources/js/module/handlebars-v1.3.0/transFormatJson', function () {
			require.async('/resources/js/module/newKkpager/kkpager.js', function () {
				...
				$.ajax({
					type: "get",
					url: "/modules/business/action/averageBusinessAction/getSellBillsTotal.htm",
				...
				var AllTransactions = require("/resources/js/page/sellerAverageUser/AllTransactions"); // 全部交易
				var PendingTransaction = require("/resources/js/page/sellerAverageUser/PendingTransaction"); // 待确认交易
				var ReviseTransaction = require("/resources/js/page/sellerAverageUser/ReviseTransaction"); // 待修改交易 
