...
define(function (require, exports, module) {
	...
	var getListDate = function () {
		...
		function insetDate(data) {
			var tpl = require('/resources/tpls/sellerAverageUser/ReviseTransaction.tpl'); //载入tpl模板
		...
		$.ajax({
			url: "/modules/business/action/averageBusinessAction/sellBillOrders.htm?businessState=" + "0020,0022",
			type: "get",
			dataType: "json",
			data: {
				currentPage: 1,
				...
				if (data.page.total > 0) {
					var obj11 = {
						...
						click: function (n, total, totalRecords) {
							$.ajax({
								type: "get",
								url: "/modules/business/action/averageBusinessAction/sellBillOrders.htm?businessState="+'0020,0022'+"&currentPage=" + n + "&pageSize=" + data.page.pageSize,
	...
	function operationClick(checkData) {
		...
		require.async(['/resources/js/module/layer/skin/default/layer.css', '/resources/js/module/layer/layer.min'], function () {
			...
			/**
				* [订单撤回] 
				*/
			$('#tradeClosed .sellerAverageRevoke').click(function () {
			...
			/**
				* [订单退回] 
				*/
			$('#tradeClosed .sellerAverageReturn').click(function () {
			 ...
			 * [确认]
			 */
			$('#tradeClosed .sellerAverageConfirm').unbind("click").click(function (e) {
			...
			/**
				* [订单关闭] 
				*/
			$('#tradeClosed .sellerAverageClose').click(function () {
			 ...
			 * [修改订单]
			 */
			$('#tradeClosed .sellerAverageChange').unbind("click").click(function (e) {
				var rid = $(this).attr("data-id") 
