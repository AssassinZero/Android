 ...
 */
package com.rd.network.converter;

import android.text.TextUtils;

import com.rd.network.utils.SerializedUtil;
...
final class RDRequestBodyConverter<T> implements Converter<T, RequestBody> {
    ...
    public RequestBody convert(T args) throws IOException {
        ...
        // 反射获取属性值
        obj2postData(args, args.getClass(), builder);
     ...
     */
    private void obj2postData(T args, Class<?> clazz, StringBuilder builder) {
        ...
        if (!clazz.getSuperclass().equals(Object.class)) {
            obj2postData(args, clazz.getSuperclass(), builder);
        }
    }
}