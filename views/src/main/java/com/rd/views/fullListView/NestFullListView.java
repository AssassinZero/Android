package com.rd.views.fullListView;
 ...
 * Date: 2016/10/27 17:06
 * <p/>
 * Description: 完全伸展开的ListView（LinearLayout）
 */
...
public class NestFullListView extends LinearLayout {
            ...
            if (null != mAdapter.getDatas() && !mAdapter.getDatas().isEmpty()) {
                ...
                for (int i = 0; i < mAdapter.getDatas().size(); i++) {
                    ...
                    if (mVHCaches.size() - 1 >= i) {// 说明有缓存，不用inflate，否则inflate
                        ...
                        mVHCaches.add(holder);// inflate 出来后 add进来缓存
                    }
    ...
    public void setFooterView(int pos, View footer) {
        if (null == mFooterViews || mFooterViews.size() <= pos) {
            ...
            // 5 item 1 footer , pos 0, getChildCount = 6, remove :
