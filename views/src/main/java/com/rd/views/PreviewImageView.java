 ...
 * Author: chaiyuan
 * Date: 2018/2/26
 * Description: 可放大缩小平移图片的ImageView
 */
...
public class PreviewImageView extends AppCompatImageView implements ScaleGestureDetector.OnScaleGestureListener, View.OnTouchListener {
    /**
     * 控件宽度
     */
    private int mWidth;
