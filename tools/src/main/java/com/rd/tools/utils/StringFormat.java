...
public class StringFormat {
    ...
    public static String oneDecimalFormat(Object args) {
        ...
        return new DecimalFormat("######0.0").format(ConverterUtil.getDouble(args.toString()));
    }
    ...
    public static String twoDecimalFormat(Object args) {
        ...
        return new DecimalFormat("######0.00").format(ConverterUtil.getDouble(args.toString()));
    }
    ...
    public static String bankcardHideFormat(String args) {
        ...
        return args.replaceAll("^(.{4})(.*)(.{3})$", "$1 **** **** $3");
    }
     ...
     * 百分比格式化
     */
    public static String percentFormat(Object args) {
        if (args != null && !TextUtil.isEmpty(args.toString())) {
            String number = args.toString();
            try {
                return new DecimalFormat("#.0#%").format(ConverterUtil.getDouble(number));
            } catch (Exception e) {
                e.printStackTrace();
                return number;
            }
    ...
    public static String doubleFormat(Object args) {
        if (args != null && !TextUtil.isEmpty(args.toString())) {
            String number = args.toString();
            try {
                return new DecimalFormat(",##0.00").format(ConverterUtil.getDouble(number));
            } catch (Exception e) {
                e.printStackTrace();
                return number;
            }
