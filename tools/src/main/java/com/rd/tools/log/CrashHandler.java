...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        ...
        if (!handleException(ex) && mDefaultCrashHandler != null) {
            ...
            try {
                ...
                com.rd.tools.log.Logger.e(TAG, "error : ", e);
            }
            // 退出程序
    ...
    private void dumpExceptionToSDCard(Throwable tr) throws IOException {
        ...
        if (!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            if (mDebug) {
                com.rd.tools.log.Logger.w(TAG, "sdcard unmounted,skip dump exception");
                return;
            }
        }
        ...
        try {
            ...
            com.rd.tools.log.Logger.e(TAG, "dump crash info failed");
        }
    }
    ...
    public void collectDeviceInfo(PrintWriter pw) {
        ...
        for (Field field : fields) {
            try {
                ...
                com.rd.tools.log.Logger.d(TAG, field.getName() + " : " + field.get(null));
            } catch (Exception e) {
                com.rd.tools.log.Logger.e(TAG, "an error occurred when collect crash info", e);
            }
        }
    }
    ...
    private void uploadExceptionToServer() {
        ...
        com.rd.tools.log.Logger.i(TAG, "upload exception to server is end!!!");
    }
}