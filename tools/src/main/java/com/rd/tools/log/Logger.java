...
public class Logger {
    ...
    public static class Builder {
        public Builder() {
            if (defaultDir != null)
                return;
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState()) && ContextHolder.getContext().getExternalCacheDir() != null)
                defaultDir = ContextHolder.getContext().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                defaultDir = ContextHolder.getContext().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
